...
export function Card({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div
      className={cn(
        "overflow-hidden rounded-[18px] border border-[var(--line)] bg-[var(--paper-raised)] text-[var(--ink)] shadow-[var(--shadow-sm)] transition-[transform,box-shadow,border-color] duration-[220ms] ease-out-soft",
        className
      )}
      {...props}
    />
